...
type ReceivedExpenseScreenProps = StackScreenProps<RootStackParamList, 'ReceivedExpense'>;

const ReceivedExpense = ({navigation} : ReceivedExpenseScreenProps) => {
                ...
                >
                    ...
                    >
                        <View style={[styles.row,{marginBottom:20}]}>
                            <Text style={[FONTS.font,FONTS.fontMedium,{color:colors.text}]}>I Received</Text>
                            <TouchableOpacity
