...
type CreateCreditNoteScreenProps = StackScreenProps<RootStackParamList, 'CreateCreditNote'>;

const CreateCreditNote = ({ navigation } : CreateCreditNoteScreenProps) => {
                ...
                >
                    ...
                    >
                        <View style={[styles.row,{marginBottom:20}]}>
                            <Text style={[FONTS.font,FONTS.fontMedium,{color:colors.text}]}>Credit Note</Text>
                            <TouchableOpacity
                        ...
                        <View style={{marginBottom:40}}>
                            ...
                            >
                                ...
                                <Text style={[FONTS.font,FONTS.fontMedium,{color:COLORS.primary}]}>New item</Text>
                            </TouchableOpacity>
                        </View>
                        <View style={[styles.row,{marginBottom:20}]}>
