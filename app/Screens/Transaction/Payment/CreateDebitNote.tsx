...
type CreateDebitNoteScreenProps = StackScreenProps<RootStackParamList, 'CreateDebitNote'>;

const CreateDebitNote = ({ navigation } : CreateDebitNoteScreenProps) => {
                ...
                >
                    ...
                    >
                        <View style={[styles.row,{marginBottom:20}]}>
                            <Text style={[FONTS.font,FONTS.fontMedium,{color:colors.text}]}>Debit Note</Text>
                            <TouchableOpacity
