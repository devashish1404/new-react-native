import { View, Text, StyleSheet, TouchableOpacity,Platform, FlatList, ScrollView } from 'react-native'
...
type PaymentOutScreenProps = StackScreenProps<RootStackParamList, 'PaymentOut'>;

const PaymentOut = ({ navigation } : PaymentOutScreenProps) => {
                ...
                >
                    ...
                    >
                        ...
                        <View style={{marginBottom:20}}>
                            <Text style={[FONTS.font,FONTS.fontMedium,{ color: colors.text,marginBottom:10 }]}>From Party</Text>
                            <CustomInput
                                inputBorder
                        ...
                        <View style={{marginBottom:20}}>
                            <Text style={[FONTS.font,FONTS.fontMedium,{ color: colors.text,marginBottom:10 }]}>Amount Received</Text>
                            <CustomInput
                                inputBorder
                            />
                        </View>
                        ...
                        <View style={{marginBottom:20}}>
                            <Text style={[FONTS.font,FONTS.fontMedium,{ color: colors.text,marginBottom:10 }]}>Address</Text>
                            <CustomInput
                                inputBorder
                            />
                        </View>
                        <View style={[styles.row,{marginBottom:20}]}>
                            {paymentMethods.map((method:any, index:any) => (
                                ...
                                >
                                    <Icon
                                        name={selectedMethod === method ? 'radiobox-marked' : 'radiobox-blank'}
                                        size={20}
                                        color={colors.text}
                                    />
                                    <Text style={[FONTS.font,FONTS.fontMedium,{color:colors.text}]}>{method}</Text>
                                </TouchableOpacity>
                            ))}
                        </View>
                        ...
                        <View style={[styles.row]}>
                            <Text style={[FONTS.font,FONTS.fontMedium,{color:colors.text,flex:1}]}>Add More Detail</Text>
                            <TouchableOpacity
                                activeOpacity={0.5}
                                style={[styles.DateButton,{right:-5}]}
                            >
