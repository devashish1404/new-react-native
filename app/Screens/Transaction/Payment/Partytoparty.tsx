...
type PartytopartyScreenProps = StackScreenProps<RootStackParamList, 'Partytoparty'>;

const Partytoparty = ({ navigation } : PartytopartyScreenProps) => {
                ...
                >
                    ...
                    >
                        <View style={[styles.row,{marginBottom:20}]}>
                            <Text style={[FONTS.font,FONTS.fontMedium,{color:colors.text}]}>Party to party</Text>
                            <TouchableOpacity
