...
type UserDetailsScreenProps = StackScreenProps<RootStackParamList, 'UserDetails'>;

const UserDetails = ({ navigation } : UserDetailsScreenProps) => {
    ...
    return (
        <SafeAreaView style={{ backgroundColor: colors.background, flex: 1 }}>
            ...
            >
                ...
                >
                    <Text style={{...FONTS.fontMedium,fontSize:18,color:colors.title,lineHeight:23}}>User Details</Text>
